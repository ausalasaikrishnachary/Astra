...
export default function InvestorHeader() {
    ...
    const navItems = [
        ...
        { label: 'Assets', path: '/i-assets' },
        {
            label: 'Transactions',
            submenu: [
                { label: 'Buy Shares', path: '/i-buy-shares' },
                { label: 'Sell Shares', path: '/i-sell-shares' },
            ],
        },
    ...
    return (
        <>
            <AppBar
                position="fixed"
                sx={{
                    backgroundColor: '#ccff90', // Adjust green color as needed.
                    color: '#000',
                    boxShadow: 'none',
                }}
            >
                    ...
                    {isMobile ? (
                        ...
                        <Box display="flex" alignItems="center" justifyContent="space-between" width="100%">
                            ...
                            <Box display="flex" alignItems="center">
                                ...
                                <Typography sx={{ ml: 2, mr: 2, color: '#000', fontWeight: 500 }}>Investor</Typography>
                                <Avatar
