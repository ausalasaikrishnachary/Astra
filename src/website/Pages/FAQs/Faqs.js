...
const faqs = [
  ...
  {
    question: "What is Oneastrarealtech app?",
    answer:
      "Think of Oneastrarealtech like Binance, but for real-world assets. While it's different from crypto, it uses the same trusted blockchain technology for transparency and security. Instead of crypto tokens, Oneastrarealtech lets you invest in tokens that represent real assets. In simple terms, [Company Name] is a tokenization platform that allows fractional ownership of top rental properties starting at just ₹ 43,894.",
  },
  {
    question: "Is Oneastrarealtech regulated?",
    answer:
      "Oneastrarealtech is regulated under Qatar Digital Assets regulations and operates with full compliance to ensure transparency, security, and trust in all tokenized real estate investments.",
  },
  {
    question: "How do I sign up for an account on Oneastrarealtech?",
    answer:
      "To sign up for Oneastrarealtech, you’ll need to provide personal information and documents like your passport and proof of address. This ensures compliance with KYC regulations under Qatar Digital Assets guidelines.",
  },
  {
    question:
      "What is the minimum amount I can invest in Oneastrarealtech?",
    answer:
      "The minimum investment amount is ₹ 43,894. This allows investors to own fractional shares in top rental properties.",
  },
  {
    question: "How does Oneastrarealtech work?",
    answer: "Oneastrarealtech lets you invest in real-world assets like rental properties by owning tokens representing fractional ownership. You can invest from as low as ₹ 43,894.",
  },
];
